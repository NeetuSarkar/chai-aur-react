    ...
    <footer className="bg-slate-50 border-y">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-slate-300 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/NeetuSarkar"
                ...
                <li>
                  <a
                    href="https://www.linkedin.com/in/neetu-sarkar/"
                    className="hover:underline"
                    target="_blank"
                    rel="noreferrer"
                  >
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-slate-200 sm:text-center">
            © 2023
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <Link to="#" className="text-slate-300 hover:text-slate-200">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
